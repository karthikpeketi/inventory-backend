 ...
 * It covers: authentication, authorization rules, JWT filtering, session management, and password encoding.
 * CORS is handled by the separate CorsFilter component for better control.
 * </p>
 */
...
public class SecurityConfig {
     ...
     * - CORS: Disabled in Spring Security (handled by separate CorsFilter component)
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        ...
        http
            .cors(AbstractHttpConfigurer::disable) // Disable Spring Security CORS - handled by CorsFilter
